...
namespace SalesWebMvc.Data
{
    ...
    {
        //Isso é uma injeção de dependência, ou seja, quando SeedingService for criado, 
        //automaticamente ele vai receber uma instancia do context também 
        private SalesWebMvcContext _context; //o context serve para ajudar na criação de seu BD.

        public SeedingService(SalesWebMvcContext context)
        {
            //um construtor para indicar que a injeção de dependênicia DEVE acontecer
            _context = context;
        }
